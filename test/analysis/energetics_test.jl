...
@testset "Test Energetics Functions" begin
  ...
  @test isapprox(0.0, getRotEnergy(new1); atol=1e-10)
  @test isapprox(0.0, getTransEnergy(new1); atol=1e-10)
  ...
  @test isapprox(0.0, getTransEnergy(new2); atol=1e-10)
  @test isapprox(0.1, getVibEnergy(new2, m[:, end]; calc=calc); atol=1e-5)

  vcom = vCoM(new2) |> norm
  @test isapprox(0.0, vcom; atol=1e-10)
